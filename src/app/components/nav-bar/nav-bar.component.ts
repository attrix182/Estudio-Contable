...
export class NavBarComponent implements OnInit {
  ...
  @ViewChild('navbarSupportedContent', { static: true })
  navbarSupportedContent: any;
  ...
  ngOnInit(): void {
    if (window.scrollY == 0) {
      this.render.setAttribute(
        this.nav_img.nativeElement,
        'style',
        'visibility:hidden;'
      );
      this.render.setAttribute(
        this.nav_logo.nativeElement,
        'style',
        'padding-left:6em;'
      );
    }
  ...
  @HostListener('window:scroll', ['$event']) onscroll() {
    if (window.scrollY > 217) {
      this.render.setAttribute(
        this.nav_img.nativeElement,
        'style',
        'width:3em;position:relative;visibility:none;'
      );
      this.render.setAttribute(
        this.nav_logo.nativeElement,
        'style',
